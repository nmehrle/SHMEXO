...
using GravFunc = void(*)(
    MeshBlock *pmb, AthenaArray<Real> &g1, AthenaArray<Real> &g2, AthenaArray<Real> &g3);
...
using FieldDiffusionCoeffFunc = void (*)(
    ...
    int is, int ie, int js, int je, int ks, int ke);
using RadiationScalingFunc = Real (*)(AthenaArray<Real> const &prim, Real time, int k, int j, int il, int iu);
